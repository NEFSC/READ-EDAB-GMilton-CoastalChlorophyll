...
#I went through these results, inspecting them all. If cdom was calculated and had the correct units, I downloaded it, there's 11 files total
...
im=axs1.scatter(bcodmo_cdom.lon,bcodmo_cdom.lat,s=10)
